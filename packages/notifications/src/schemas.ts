...
export type NotificationTypes = {
	...
	sales_dispatch_approval_pending_released: SalesDispatchApprovalPendingReleasedInput;
	...
	sales_production_unassigned: SalesProductionUnassignedInput;
	sales_production_submitted: SalesProductionSubmittedInput;
...
>;
export const salesDispatchApprovalPendingReleasedSchema =
	salesDispatchAssignedSchema;
export type SalesDispatchApprovalPendingReleasedInput = z.infer<
	typeof salesDispatchApprovalPendingReleasedSchema
>;
export const salesDispatchApprovalPendingReleasedTags = actityTagsSchema.extend(
	salesDispatchApprovalPendingReleasedSchema.shape,
);
export type SalesDispatchApprovalPendingReleasedTags = z.infer<
	typeof salesDispatchApprovalPendingReleasedTags
>;
...
export type SalesDispatchCreatedTags = z.infer<typeof salesDispatchCreatedTags>;
...
>;
export const salesProductionUnassignedSchema = z.object({
	salesId: z.number(),
	orderNo: z.string().optional(),
...
export type SalesProductionUnassignedInput = z.infer<
	typeof salesProductionUnassignedSchema
>;
export const salesProductionUnassignedTags = actityTagsSchema.extend(
	salesProductionUnassignedSchema.shape,
);
export type SalesProductionUnassignedTags = z.infer<
	typeof salesProductionUnassignedTags
>;
export const salesProductionSubmittedSchema = z.object({
	salesId: z.number(),
	orderNo: z.string().optional(),
	salesRepId: z.number(),
...
export type SalesProductionSubmittedInput = z.infer<
	typeof salesProductionSubmittedSchema
>;
export const salesProductionSubmittedTags = actityTagsSchema.extend(
	salesProductionSubmittedSchema.shape,
);
export type SalesProductionSubmittedTags = z.infer<
	typeof salesProductionSubmittedTags
>;
...
export const notificationJobSchema = z.discriminatedUnion("channel", [
	...
	baseNotificationJobSchema.extend({
		channel: z.literal("sales_dispatch_approval_pending_released"),
		payload: salesDispatchApprovalPendingReleasedSchema,
	}),
	baseNotificationJobSchema.extend({
	...
	baseNotificationJobSchema.extend({
		channel: z.literal("sales_production_unassigned"),
		payload: salesProductionUnassignedSchema,
	}),
	baseNotificationJobSchema.extend({
		channel: z.literal("sales_production_submitted"),
		payload: salesProductionSubmittedSchema,
	}),
	baseNotificationJobSchema.extend({
