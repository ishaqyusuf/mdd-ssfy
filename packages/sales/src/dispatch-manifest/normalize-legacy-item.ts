...
function quantity(value: DispatchQuantity | null | undefined): NormalizedQuantity {
...
export function normalizeLegacyDispatchManifestItem(
	...
	if (savedSwing && quantityHanding && hasSwingConflict(savedSwing, orderedQty)) {
	...
	return {
		...
		swing: savedSwing,
		handingLabel:
			quantityHanding || savedSwing || (requiresHanding ? "Handing not recorded" : "Not applicable"),
		orderedQty,
		packedQty,
