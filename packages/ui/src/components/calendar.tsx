  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn("bg-accent/50 rounded-full", defaultClassNames.today),
        outside: cn(
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <Icons.ChevronLeftIcon className={cn("size-4", className)} {...props} />
            );
          }
          ...
          return (
            <Icons.ChevronDownIcon className={cn("size-4", className)} {...props} />
          );
        },
