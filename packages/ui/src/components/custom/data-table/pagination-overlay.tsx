	...
	return (
		<div className="pointer-events-none fixed bottom-10 left-1/2 z-[9] hidden -translate-x-1/2 md:block">
			<motion.div
				...
				className={cn(
					"pointer-events-auto flex min-w-[260px] items-center justify-between gap-4 overflow-hidden rounded-xl border border-muted-foreground/40 bg-white/95 px-4 py-2 shadow-xl backdrop-blur",
				)}
			>
