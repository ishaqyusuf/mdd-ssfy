...
import type { CellHeader, RowCell, ShelfSection } from "@gnd/sales/print/types";
			...
			{remainingRows.map((row, rowIndex) => {
				...
				return (
					<View
						...
						style={{
							flexDirection: "row",
							backgroundColor: rowIndex % 2 === 0 ? ROW_ALT : "#ffffff",
							borderBottomWidth: rowIndex < remainingRows.length - 1 ? 1 : 0,
							borderBottomColor: BORDER,
						}}
					>
						{visualCells.map((column, ci) => (
