...
- `brain/tasks.md` — active tasks and priorities
- `brain/progress.md` — current progress and blockers
- `brain/architecture.md` — system architecture overview
...
- Update `brain/tasks.md` if a task was completed or a new one was discovered
