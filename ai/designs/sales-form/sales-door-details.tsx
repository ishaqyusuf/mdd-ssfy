...
export const SalesDoorDetailModal: React.FC<SalesDoorDetailModalProps> = ({
  isOpen,
  onClose,
}) => {
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card">
          <div>
            <h2 className="text-foreground text-xl font-bold leading-tight tracking-[-0.015em]">
              Solid Core Smooth 2-Panel Arch Top
            </h2>
            <p className="text-sm text-muted-foreground mt-1">
              Select sizes and quantities for this product.
            </p>
          </div>
          <button
            onClick={onClose}
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-muted/50 border-b border-border">
                      ...
                      <th className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider w-32">
                        Unit Cost
                      </th>
                      <th className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider w-32">
                        Qty
                  ...
                  <tbody className="divide-y divide-border">
                    ...
                    <tr className="group hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="relative">
                          <span className="absolute inset-y-0 left-2 flex items-center text-muted-foreground text-sm">
                            $
                          </span>
                          <input
                            className="block w-full pl-5 pr-2 py-1.5 text-sm border border-input bg-background rounded-md focus:ring-1 focus:ring-primary outline-none"
                            type="number"
                            defaultValue="145.00"
                            step="0.01"
                          />
                      ...
                      <td className="px-4 py-3">
                        <input
                          className="block w-full px-2 py-1.5 text-sm border border-input bg-background rounded-md focus:ring-1 focus:ring-primary outline-none text-center"
                          type="number"
                          min="0"
                          defaultValue="0"
                        />
                    ...
                    <tr className="group hover:bg-muted/30 transition-colors bg-primary/5">
                      ...
                      <td className="px-4 py-3">
                        <input
                          className="block w-full px-2 py-1.5 text-sm border border-primary rounded-md focus:ring-1 focus:ring-primary outline-none text-center font-bold text-foreground ring-1 ring-primary/20"
                          type="number"
                          min="0"
                          defaultValue="2"
                        />
                    ...
                    <tr className="group bg-muted/30 text-muted-foreground">
                      ...
                      <td className="px-4 py-3">
                        <div className="relative opacity-60">
                          ...
                          <input
                            className="block w-full pl-5 pr-2 py-1.5 text-sm border border-border bg-muted rounded-md cursor-not-allowed"
                            type="number"
                            defaultValue="165.00"
                            disabled
                          />
                      ...
                      <td className="px-4 py-3">
                        <input
                          className="block w-full px-2 py-1.5 text-sm border border-border bg-muted rounded-md cursor-not-allowed text-center"
                          type="number"
                          min="0"
                          defaultValue="0"
                          disabled
        ...
        <div className="px-6 py-4 bg-card border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-end sm:items-center gap-6">
            <div className="flex items-baseline gap-2">
              ...
              <h3 className="text-foreground text-2xl font-bold leading-none tracking-tight">
                $470.00
              </h3>
            </div>
