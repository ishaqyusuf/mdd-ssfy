...
export const MouldingCalculatorModal: React.FC<
  MouldingCalculatorModalProps
> = ({ isOpen, onClose, onApply, productName = "FLAT BOARD 1 X 6" }) => {
            ...
            <div className="mt-3 pt-3 border-t border-border">
              <div className="flex justify-between text-[11px]">
                <span className="text-muted-foreground">
                  Budget (${budget}) ÷ ${pricePerLF}/LF
                </span>
                <span className="text-muted-foreground font-medium">
                  {calculatedBaseLF.toFixed(1)} LF Base + {waste}% Waste
                </span>
              </div>
            </div>
          </section>
