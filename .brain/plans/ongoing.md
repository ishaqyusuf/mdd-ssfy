...
- Blockers: None
- Related Files: brain/features/install-cost-sorting.md, apps/api/src/trpc/routers/community.route.ts, apps/api/src/utils/install-cost-sort.ts, apps/api/src/utils/install-cost-sort.test.ts, apps/dashboard/src/hooks/use-model-install-config.ts, apps/dashboard/src/components/modals/new-job/install-tasks-list.tsx, apps/mobile/src/components/forms/job-v2/install-cost-form.tsx, apps/mobile/src/hooks/use-job-form-v2.tsx
...
- Blockers: None
- Related Files: brain/features/sales-pdf-system.md, brain/tasks/in-progress.md, apps/dashboard/src/components/print-sales-v2.tsx, apps/dashboard/src/components/sales-menu-print.tsx, apps/dashboard/src/components/sales-preview.tsx
...
- Status: In Progress
- Objective: Optimize `apps/dashboard` active routes using `apps/dashboard/src/components/sidebar/links.ts` as the authoritative scope for current user-facing pages, and track non-linked route pages as possibly stale for later review.
...
- Blockers: None
- Related Files: brain/link-modules-web-optimization-plan.md, brain/engineering/dashboard-routes.md, brain/engineering/dashboard-performance-guardrails.md, apps/dashboard/src/components/sidebar/links.ts, apps/dashboard/src/app/(sidebar)/community/(main)/templates/page.tsx, apps/dashboard/src/app/(sidebar)/community/community-template/[slug]/page.tsx, apps/dashboard/src/app/(sidebar)/community/community-template/[slug]/v1/page.tsx, apps/dashboard/src/app/(sidebar)/community/model-template/[slug]/page.tsx, apps/dashboard/src/app/(sidebar)/community/template-schema/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/projects/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/project-units/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/unit-productions/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/unit-invoices/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/builders/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/install-costs/page.tsx, apps/dashboard/src/app/(sidebar)/community/customer-services/page.tsx, apps/dashboard/src/components/modals/global-modals.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/orders/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/orders/bin/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/quotes/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/quotes/bin/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/customers/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/dispatch-admin/page.tsx, apps/dashboard/src/components/tables/sales-orders/data-table.tsx, apps/dashboard/src/components/tables/sales-quotes/data-table.tsx, apps/dashboard/src/components/tables/customers/data-table.tsx, apps/dashboard/src/components/tables/sales-dispatch/data-table.tsx
- Related Files: brain/link-modules-web-optimization-plan.md, brain/engineering/dashboard-routes.md, brain/engineering/dashboard-performance-guardrails.md, brain/engineering/dashboard-performance-validation-checklist.md, apps/dashboard/src/components/sidebar/links.ts, apps/dashboard/src/app/(sidebar)/community/(main)/templates/page.tsx, apps/dashboard/src/app/(sidebar)/community/community-template/[slug]/page.tsx, apps/dashboard/src/app/(sidebar)/community/community-template/[slug]/v1/page.tsx, apps/dashboard/src/app/(sidebar)/community/model-template/[slug]/page.tsx, apps/dashboard/src/app/(sidebar)/community/template-schema/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/projects/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/project-units/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/unit-productions/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/unit-invoices/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/builders/page.tsx, apps/dashboard/src/app/(sidebar)/community/(main)/install-costs/page.tsx, apps/dashboard/src/app/(sidebar)/community/customer-services/page.tsx, apps/dashboard/src/components/modals/global-modals.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/orders/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/orders/bin/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/quotes/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/quotes/bin/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/customers/page.tsx, apps/dashboard/src/app/(sidebar)/(sales)/sales-book/dispatch-admin/page.tsx, apps/dashboard/src/components/tables/sales-orders/data-table.tsx, apps/dashboard/src/components/tables/sales-quotes/data-table.tsx, apps/dashboard/src/components/tables/customers/data-table.tsx, apps/dashboard/src/components/tables/sales-dispatch/data-table.tsx
...
- Blockers: None
- Related Files: brain/legacy-sales-form-mobile-architecture-plan.md, brain/sales-form-system-hardening-plan.md, brain/decisions/ADR-005-legacy-sales-form-domain-and-mobile-architecture.md, apps/dashboard/src/components/forms/sales-form/sales-form.tsx, apps/dashboard/src/components/forms/sales-form/sales-form-sidebar.tsx, apps/dashboard/src/components/forms/sales-form/sales-form-save.tsx, apps/dashboard/src/components/forms/sales-form/sales-meta-form.tsx, apps/dashboard/src/app-deps/(clean-code)/(sales)/sales-book/(form)/_components/item-section.tsx, apps/dashboard/src/app-deps/(clean-code)/(sales)/sales-book/(form)/_components/step-section.tsx
- Last Updated: 2026-04-16

### Planned Steps
1. Create `apps/dashboard/src/domains/sales-form/legacy/*` and route the current shell through one canonical entrypoint.
...
- Blockers: None
- Related Files: packages/sales/src/utils/where-queries.ts, packages/sales/src/schema.ts, apps/api/src/schemas/sales.ts, apps/api/src/utils/sales.ts, apps/api/src/db/queries/sales.ts, apps/api/src/db/queries/sales-orders-v2.ts, apps/dashboard/src/hooks/use-sales-filter-params.ts, apps/dashboard/src/hooks/use-sales-orders-v2-filter-params.ts, apps/dashboard/src/components/sales-order-search-filter.tsx, apps/dashboard/src/components/sales-orders-v2-header.tsx, apps/api/src/db/queries/filters.ts
...
8. Verify with one manual pass on canonical `/sales-book/orders` plus a redirect smoke for `/sales-book/orders/v2`: default list size is reduced, explicit filters still reveal the hidden/stale rows, summaries match the active filter, and sales-rep scoping remains intact.
...
3. [x] Phase 3: Establish shared sales form state contract. Created package-owned state types, initial state, reducers/actions, selectors, and tests; `apps/dashboard` `store.ts` is now a thin Zustand adapter around package state/actions while preserving the app's router-derived record type externally.
4. [x] Phase 4: Complete shared composition root. `SalesFormShell` now supports fixed `www` and embedded dealership surfaces, accepts a composition object with record/state/data/actions/permissions/capabilities/slots, and is used by both `apps/dashboard` new sales form and dealership quote composer.
...
10. [x] Phase 10: Cleanup and deletion. Delete obsolete `apps/dashboard` form UI sections, compatibility re-exports, duplicated dealership composer UI, and any remaining app-owned shared TSX.
...
9. Added the dedicated `apps/dashboard` Dealers admin page using the Midday-style split: thin server route, `HydrateClient` prefetch, `AuthGuard`, and client feature component consuming shared `dealer` tRPC procedures.
...
11. Ran `bun run --filter @gnd/dashboard typecheck`; full check still fails from unrelated existing API/UI errors, but filtered validation shows no errors in `dealers-admin-page`, `sales-book/dealers`, `dealer.route`, `schemas/dealer`, or `queries/dealers`.
...
35. Moved the `apps/dashboard` new sales form mapper/normalization layer into `packages/sales/src/sales-form/application/record-normalization.ts`, leaving `apps/dashboard` with a thin typed adapter so the existing form consumes the shared package contract.
...
38. Corrected the shared package architecture to include reusable `.tsx` as well as `.ts`, then moved the first shared React UI slice (`SalesFormHeaderActions` and `SalesFormStatusStrip`) into `packages/sales/src/sales-form/ui` with `apps/dashboard` compatibility re-exports.
39. Moved `LineItemsPanel` into `packages/sales/src/sales-form/ui/line-items-panel.tsx` as a prop-driven shared TSX component, leaving `apps/dashboard` with only a store adapter.
...
44. Added neutral app adapter folders for `apps/dashboard` and `apps/dealership` using `use-sales-form-*` names without app prefixes.
45. Moved the invoice summary sidebar shell into `packages/sales/src/sales-form/ui/summary/invoice-summary-sidebar.tsx`, with `apps/dashboard` now passing overview/history through slots and adapters.
...
49. Extracted reusable overview customer and invoice details TSX into `packages/sales/src/sales-form/ui/overview`, leaving `apps/dashboard` invoice overview as mostly data/effect adapter code.
...
53. Moved the workflow active-item controller, moulding workflow hook, and component skeleton grid into `packages/sales`, then removed the now-empty `apps/dashboard/.../sections/item-workflow` folder so `www` no longer owns shared workflow leaf files.
...
55. Moved package-owned workflow modal exports out of `apps/dashboard` by replacing the local `workflow-modals.tsx` implementation with a compatibility re-export from `@gnd/sales/sales-form`.
...
59. Extracted the package-owned `WorkflowLineList` renderer from the bottom of `apps/dashboard` `item-workflow-panel.tsx`, so the item-card list/step-chip shell is now shared and `www` only supplies store callbacks and the active step panel render function.
...
73. Added a package-owned `WorkflowStepRenderer` boundary for the next state/controller phase, so the remaining branch selection can move out of `apps/dashboard` without introducing a bloated shared file.
...
76. Rewired `apps/dashboard` `item-workflow-panel.tsx` to consume shared workflow records/helpers and `getWorkflowSteps()` at the adapter boundary, reducing the panel from 4,256 to 3,961 lines and clearing the focused `item-workflow-panel.tsx` typecheck scan.
...
78. Rewired `apps/dashboard` `item-workflow-panel.tsx` to call the shared selection actions and keep only Zustand `updateLineItem`, active-step state updates, and editor activation locally, reducing the panel from 3,961 to 3,826 lines.
...
81. Rewired `apps/dashboard` `item-workflow-panel.tsx` to use the package-owned component edit actions while keeping modal open/close state, browser prompt, uploads, and Zustand writes in the app adapter.
...
85. Rewired `apps/dashboard` `item-workflow-panel.tsx` to delegate door/HPT/moulding patch calculations to package-owned actions, keeping only Zustand writes and active-door/step UI state in the app.
...
89. Rewired `apps/dashboard` `item-workflow-panel.tsx` to consume `HousePackageToolPanel` and `WorkflowStepRenderer`, reducing the app panel from 3,458 lines after Phase 1 to 2,946 lines while keeping app-only dev logging, supplier APIs, prompts, uploads, and Zustand writes outside the package.
...
92. Completed Phase 2 focused validation: the workflow action/dual-pricing package suite remains 17 passing tests, and focused `@gnd/dashboard` / `@gnd/sales` scans are quiet for the migrated workflow files aside from unrelated existing repository typecheck noise.
...
94. Replaced the 502-line `apps/dashboard` sales form Zustand store implementation with a 159-line adapter that delegates all pure state transitions to `packages/sales` while keeping the existing `useNewSalesFormStore` API stable for `www` components.
...
96. Ran focused `@gnd/dashboard` and `@gnd/sales` typecheck scans for `new-sales-form/store`, sales-form state modules, and package exports; scans are quiet for the Phase 3 files. Full package/app typechecks still inherit unrelated existing repository errors, including `bun:test` type declarations and legacy `www` surfaces.
...
98. Cut `apps/dashboard` `NewSalesForm` onto `SalesFormShell`, passing customer selector, payment review, recovery banner, workflow panel, floating actions, overview summary, and sales history through slots while preserving existing save, print, packing, settings, and permission behavior.
...
100. Re-ran the combined dual-pricing/workflow/state suite with 17 passing tests; focused `@gnd/sales`, `@gnd/dashboard`, and `@gnd/dealership` scans are quiet for the Phase 4 shell/composition files.
...
107. Rewired `apps/dashboard` `NewSalesForm` and `item-workflow-panel.tsx` to import shared package components directly from `@gnd/sales/sales-form` instead of local wrapper files.
...
112. Added focused workflow line total tests; the combined dual-pricing/workflow/state/overview suite now has 22 passing tests and 0 failures. Focused `@gnd/dashboard` scans are quiet for the touched Phase 6 files; focused `@gnd/sales` scans only show existing `bun:test` type-declaration noise for test files.
...
114. Rewired `apps/dashboard` `item-workflow-panel.tsx` normal-step and door-step component lists to call `resolveWorkflowVisibleComponents`, keeping only app query inputs and memo dependencies local.
...
117. Rewired `apps/dashboard` `item-workflow-panel.tsx` to call `buildWorkflowShelfSyncPatch`, `buildInitialWorkflowShelfPatch`, and `buildWorkflowDoorSyncPatch`, leaving only dev-flow logging and Zustand `updateLineItem` writes in the app adapter.
118. Added focused sync patch tests; the combined dual-pricing/workflow/state/overview suite now has 26 passing tests and 0 failures. Focused `@gnd/dashboard` scans are quiet for the touched Phase 6 files, and focused `@gnd/sales` scans only show existing `bun:test` type-declaration noise for test files. `item-workflow-panel.tsx` is down to 2,616 lines.
...
120. Rewired `apps/dashboard` `item-workflow-panel.tsx` to use the shared row patch helpers while keeping dev-flow logging, product/category option wiring, prompts, modal state, and Zustand writes local.
121. Added focused workflow row patch tests; the combined dual-pricing/workflow/state/overview suite now has 31 passing tests and 0 failures. Focused `@gnd/dashboard` scans are quiet for the touched Phase 6 files, and focused `@gnd/sales` scans only show existing `bun:test` type-declaration noise for test files. `item-workflow-panel.tsx` is down to 2,533 lines.
122. Finished Phase 6 by moving component-picker select-all and component redirect patch generation into `workflow-selection-actions.ts`, then rewired `apps/dashboard` `item-workflow-panel.tsx` to keep only the Zustand write and active-step/modal state update.
...
145. Ran focused Phase 11 type scans: `@gnd/dealership` shows no dealer portal/sales-form/session/API route matches; `@gnd/dashboard` only reports known legacy download route `qrCodeDataUrl`/`Buffer` issues and the existing new-sales-form settings modal type issue.
...
### Resume Prompt
Continue the Dealership Program from `brain/plans/ongoing.md`. Current phase: Phase 11 build/runtime smoke is complete for unauthenticated dealership routes, but authenticated browser click-through requires a valid dealer login/session; Phase 12 should wait until the remaining authenticated Phase 11 smoke is completed. Dealer quote creation/edit/conversion is wired to shared package UI and the overview plus workflow leaf TSX/hooks/modals/list/toolbar/grid/preview/card/actions/pickers/moulding-popover/door-step/service-editor/moulding-editor/shelf-sections/supplier-manager shells plus workflow record/format helpers and package-owned selection, component edit/price override, door/HPT, moulding action modules, state modules, visible-component helpers, line-total helpers, shelf/door sync patch helpers, workflow row patch helpers, select-all helpers, redirect patch helpers, dual-pricing snapshot helpers, print branding helpers, and dealer-isolation DB guards have moved into `packages/sales`/`packages/db` boundaries. Phase 11 validation completed so far: the broad migration suite passes with 44 tests and 148 expects; focused dealership scans show no dealer portal/sales-form/session/API errors; focused `www` scans only report known legacy download route and settings modal type issues; `bun run --filter @gnd/dealership build` passes; built dealership runtime returns 200 for `/login` and 307 redirects to `/login` for protected `/quotes`, `/customers`, and `/settings` when unauthenticated. Remaining blocker: a valid dealer login/session is needed for authenticated browser QA, and headless Chromium still cannot launch from this Codex sandbox due macOS MachPort permission errors even after installing matching Playwright browsers. Important product decisions: dealers are managed from a dedicated Dealers page, adding a dealer supports existing customer lookup or new dealer name/email invite, onboarding sends a setup guide through the channel notification system, dealer-managed customers are separate dealer-owned records, dealer auth uses Better Auth from `packages/auth`, the new sales form system in `packages/sales` is shared by `apps/dashboard` and `apps/dealership`, the shared sales package can include both `.ts` and `.tsx`, app projects keep neutral `use-sales-form-*` route/session/API adapters, feature visibility is controlled by explicit capabilities and permissions, and v1 billing is ledger-only. Update `brain/plans/ongoing.md` as progress continues.
## Production Worker Queue Enhancements
- Status: In Progress
- Objective: Improve production operations with persistent completed calendar entries, selected-order rescheduling and assignment, clearer worker item/inbound context, and responsive tablet behavior.
- Current Phase: Calendar and batch-action implementation
- Next Step: Remove the pending-only calendar constraint, add focused coverage, then implement the selected-order batch editor.
- Blockers: None
- Related Files: packages/sales/src/sales-production.ts, packages/sales/src/production-v2/application/production-materials.ts, apps/api/src/trpc/routers/sales.route.ts, apps/dashboard/src/components/production-workspace.tsx, apps/dashboard/src/components/tables-2/sales-production/bottom-bar.tsx, apps/dashboard/src/components/sales-production/calendar.tsx, apps/dashboard/src/components/sheets/sales-overview-sheet/index.tsx, apps/dashboard/src/components/sheets/sales-overview-sheet/production/v2/production-tab-v2.tsx, packages/ui/src/components/custom/sheet-v2.tsx, .brain/features/sales-production-workspace.md, .brain/progress.md
- Last Updated: 2026-09-01

### Plan
1. Keep completed production assignments visible in the admin and worker calendars, including the completed visual treatment.
2. Add a permission-checked selected-order batch editor for rescheduling and assigning or reassigning active production assignments.
3. Move worker search beneath the tabs and strengthen production-item subtitle hierarchy.
4. Add worker-only inbound context showing material, supplier/order source, open inbound quantity, and expected arrival.
5. Make the production-worker sales overview sheet full-screen at tablet widths.
6. Add focused regression coverage, run narrow type/test validation, and verify phone/tablet layouts in the in-app browser.
7. Update the Production feature Brain page and chronological progress log.

### Resume Prompt
Continue the Production Worker Queue Enhancements from `.brain/plans/ongoing.md`. Current phase: calendar and batch-action implementation. Next step: remove the pending-only calendar constraint, add focused coverage, then implement the selected-order batch editor. Blockers: none. Relevant files are `packages/sales/src/sales-production.ts`, `packages/sales/src/production-v2/application/production-materials.ts`, `apps/api/src/trpc/routers/sales.route.ts`, `apps/dashboard/src/components/production-workspace.tsx`, `apps/dashboard/src/components/tables-2/sales-production/bottom-bar.tsx`, `apps/dashboard/src/components/sales-production/calendar.tsx`, `apps/dashboard/src/components/sheets/sales-overview-sheet/index.tsx`, `apps/dashboard/src/components/sheets/sales-overview-sheet/production/v2/production-tab-v2.tsx`, and `packages/ui/src/components/custom/sheet-v2.tsx`. Preserve existing dirty user changes, keep updates permission-checked and Midday-style, test at phone and tablet widths, and update `.brain/plans/ongoing.md` as progress continues.
