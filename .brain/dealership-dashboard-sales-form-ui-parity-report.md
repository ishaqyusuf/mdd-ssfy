...
`apps/dashboard/src/components/forms/new-sales-form/new-sales-form.tsx` imports both:

- `ItemWorkflowPanel` from `./sections/item-workflow-panel`
- `DashboardSalesFormWorkflowPanel` from `./sections/dashboard-sales-form-workflow-panel`
...
`DashboardSalesFormWorkflowPanel` already gates admin-only workflow capabilities:
