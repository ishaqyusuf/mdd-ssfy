...
- Use `.brain/AI_PROMPT_RULES.md` and `.brain/engineering/ai-rules.md` for standing AI/skill requirements, including the mandatory React/Next.js UI skill set for `apps/dashboard`, `apps/dealership`, and shared React UI consumed by those apps.
