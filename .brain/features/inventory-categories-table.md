...
- Table module: `apps/dashboard/src/components/tables-2/inventory-categories/*`
...
- Legacy files under `apps/dashboard/src/components/tables/inventory-categories/*` were removed after import scans found no remaining consumers.
...
- Full `@gnd/dashboard` typecheck remains blocked by existing workspace baseline errors; filtered output had no diagnostics for the touched category route/table/header/settings/config files.
