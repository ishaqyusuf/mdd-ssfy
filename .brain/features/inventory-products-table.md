...
- Table module: `apps/dashboard/src/components/tables-2/inventory-products/*`
...
- Legacy files under `apps/dashboard/src/components/tables/inventory-products/*` were removed after import scans found no remaining consumers.

## Embedded Product Form Variant Grid
- 2026-07-17 update: `apps/dashboard/src/components/forms/inventory-products/product-variants.tsx` now uses `components/tables-2/inventory-product-form-variants/*` for the variant grid inside the inventory product form.
...
- 2026-07-17 update: `apps/dashboard/src/components/forms/inventory-products/category-sub-components-section.tsx` now uses `components/tables-2/inventory-product-form-sub-components/*` for the Door Builder Components grid inside the inventory product form.
...
- Full `@gnd/dashboard` typecheck remains blocked by existing workspace baseline errors; filtered output had no diagnostics for the touched inventory route/table/header/settings/config files.
