...
- Surface: `apps/dashboard/src/components/forms/sales-form/door-suppliers.tsx`
- Table module: `apps/dashboard/src/components/tables-2/door-suppliers/*`
...
- 2026-07-17: touched-file filtered `@gnd/dashboard` typecheck grep reported no diagnostics.
