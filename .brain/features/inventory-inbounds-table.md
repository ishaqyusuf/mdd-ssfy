...
## Current Behavior
- The route uses the restarted Sales Orders table standard through `apps/dashboard/src/components/tables-2/inventory-inbounds/*` for the primary inbound shipment queue.
...
## Validation
- `bun test apps/dashboard/src/components/tables-2/inventory-inbounds/migration-parity.test.ts apps/dashboard/src/components/page-sticky-header.test.ts` passed with 6 tests / 22 assertions.
- `bun test apps/dashboard/src/components/tables-2/*/migration-parity.test.ts apps/dashboard/src/components/page-sticky-header.test.ts` passed with 84 tests / 733 assertions.
