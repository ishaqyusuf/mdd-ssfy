...
| 11 | Replace `www` wrapper with shared engine | `DashboardSalesFormWorkflowPanel` becomes a thin adapter around package engine. | Complete |
...
- Package code does not import from `apps/dashboard` or `apps/dealership`.
