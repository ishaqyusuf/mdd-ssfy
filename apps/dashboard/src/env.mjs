...
const server = z.object({
	...
	SQUARE_FORCE_PRODUCTION: z.enum(["true", "false"]).optional(),
...
const client = z.object({
	...
	NEXT_PUBLIC_NEW_SALES_FORM_PACKAGE_PANEL_DEFAULT: z
		.enum(["legacy", "package"])
		.optional(),
...
const processEnv = {
	...
	SQUARE_FORCE_PRODUCTION: process.env.SQUARE_FORCE_PRODUCTION,
	...
	NEXT_PUBLIC_NEW_SALES_FORM_PACKAGE_PANEL_DEFAULT:
		process.env.NEXT_PUBLIC_NEW_SALES_FORM_PACKAGE_PANEL_DEFAULT,
