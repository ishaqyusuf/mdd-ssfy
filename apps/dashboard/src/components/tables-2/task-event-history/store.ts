...
import type { TaskEventHistoryRow } from "./columns";

interface TaskEventHistoryTableState {
	columns: Column<TaskEventHistoryRow, unknown>[];
	setColumns: (columns: Column<TaskEventHistoryRow, unknown>[]) => void;
...
export const useTaskEventHistoryTableStore = create<TaskEventHistoryTableState>(
	(set) => ({
		columns: [],
