...
import type { UnitInvoiceRow } from "./columns";

interface UnitInvoicesTableState {
	columns: Column<UnitInvoiceRow, unknown>[];
	setColumns: (columns: Column<UnitInvoiceRow, unknown>[]) => void;
...
export const useUnitInvoicesTableStore = create<UnitInvoicesTableState>(
	(set) => ({
		columns: [],
