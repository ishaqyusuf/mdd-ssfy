...
interface CommunityProjectsTableState {
	columns: Column<CommunityProjectRow, unknown>[];
	rowSelection: RowSelectionState;
	showColumnDividers: boolean;
	setColumns: (columns: Column<CommunityProjectRow, unknown>[]) => void;
...
export const useCommunityProjectsTableStore =
	create<CommunityProjectsTableState>((set) => ({
		columns: [],
		rowSelection: {},
