...
interface InventoryAllocationsTableState {
	columns: Column<InventoryAllocationRow, unknown>[];
	setColumns: (columns: Column<InventoryAllocationRow, unknown>[]) => void;
...
export const useInventoryAllocationsTableStore =
	create<InventoryAllocationsTableState>((set) => ({
		columns: [],
		rowSelection: {},
