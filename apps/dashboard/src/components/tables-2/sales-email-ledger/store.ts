...
import type { SalesEmailLedgerRow } from "./columns";

interface SalesEmailLedgerTableState {
	columns: Column<SalesEmailLedgerRow, unknown>[];
	setColumns: (columns: Column<SalesEmailLedgerRow, unknown>[]) => void;
...
export const useSalesEmailLedgerTableStore = create<SalesEmailLedgerTableState>(
	(set) => ({
		columns: [],
