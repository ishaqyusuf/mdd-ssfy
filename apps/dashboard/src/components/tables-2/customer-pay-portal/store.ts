...
import type { CustomerPayPortalRow } from "./columns";

interface CustomerPayPortalTableState {
	columns: Column<CustomerPayPortalRow, unknown>[];
	setColumns: (columns: Column<CustomerPayPortalRow, unknown>[]) => void;
...
export const useCustomerPayPortalTableStore =
	create<CustomerPayPortalTableState>((set) => ({
		columns: [],
