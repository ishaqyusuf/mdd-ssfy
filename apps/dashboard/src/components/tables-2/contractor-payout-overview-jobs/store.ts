...
import type { ContractorPayoutOverviewJobRow } from "./columns";

interface ContractorPayoutOverviewJobsTableState {
	columns: Column<ContractorPayoutOverviewJobRow, unknown>[];
	setColumns: (
		columns: Column<ContractorPayoutOverviewJobRow, unknown>[],
	) => void;
...
export const useContractorPayoutOverviewJobsTableStore =
	create<ContractorPayoutOverviewJobsTableState>((set) => ({
		columns: [],
