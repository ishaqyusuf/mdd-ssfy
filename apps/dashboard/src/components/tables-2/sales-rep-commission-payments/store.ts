...
import type { SalesRepCommissionPaymentRow } from "./columns";

interface SalesRepCommissionPaymentsTableState {
	columns: Column<SalesRepCommissionPaymentRow, unknown>[];
	setColumns: (
		columns: Column<SalesRepCommissionPaymentRow, unknown>[],
	) => void;
...
export const useSalesRepCommissionPaymentsTableStore =
	create<SalesRepCommissionPaymentsTableState>((set) => ({
		columns: [],
