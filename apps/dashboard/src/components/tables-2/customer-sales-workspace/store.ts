...
import type { CustomerSalesWorkspaceRow } from "./columns";

interface CustomerSalesWorkspaceTableState {
	columns: Column<CustomerSalesWorkspaceRow, unknown>[];
	setColumns: (columns: Column<CustomerSalesWorkspaceRow, unknown>[]) => void;
...
export const useCustomerSalesWorkspaceTableStore =
	create<CustomerSalesWorkspaceTableState>((set) => ({
		columns: [],
