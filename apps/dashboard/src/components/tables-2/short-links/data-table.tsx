...
import {
	type ShortLinkRow,
	type ShortLinksTableActions,
	getShortLinkRowId,
	getShortLinksColumns,
} from "./columns";
import { EmptyState, NoResults } from "./empty-states";
import { useShortLinksTableStore } from "./store";
import { DataTableHeader } from "./table-header";

const NON_CLICKABLE_COLUMNS = new Set(["select", "actions"]);
const TABLE_ID = "short-links";
const tableConfig = TABLE_CONFIGS[TABLE_ID];

type ShortLinksInput = RouterInputs["shortLinks"]["list"];
type ShortLinksPage = {
	data?: ShortLinkRow[];
	meta?: {
...
type Props = {
	...
	defaultFilters?: ShortLinksInput;
	singlePage?: boolean;
...
export function DataTable({
	...
	const infiniteQueryOptions = trpc.shortLinks.list.infiniteQueryOptions(
		queryInput,
		{
	...
	const { data, fetchNextPage, hasNextPage, isFetchingNextPage } =
		useSuspenseInfiniteQuery<ShortLinksPage>(infiniteQueryOptions as never);
