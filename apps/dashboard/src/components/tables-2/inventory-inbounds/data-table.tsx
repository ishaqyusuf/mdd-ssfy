...
import {
	...
	getInventoryInboundColumns,
	getInventoryInboundRowId,
} from "./columns";
import { EmptyState } from "./empty-states";
import { InventoryInboundsSkeleton } from "./skeleton";
import { useInventoryInboundsTableStore } from "./store";
import { DataTableHeader } from "./table-header";

const NON_CLICKABLE_COLUMNS = new Set(["actions"]);
const TABLE_ID = "inventory-inbounds";
const tableConfig = TABLE_CONFIGS[TABLE_ID];

type Props = {
	data: InventoryInboundRow[];
...
export function DataTable({
	...
	const { setColumns, bindShowColumnDividers } =
		useInventoryInboundsTableStore();
	...
	const columns = useMemo(() => getInventoryInboundColumns(actions), [actions]);
	...
	const tableData = useMemo<InventoryInboundRow[]>(() => data, [data]);
	const table = useReactTable({
		data: tableData,
		getRowId: getInventoryInboundRowId,
		columns,
	...
	return (
		<div className="relative">
			<div className="w-full">
				...
				>
					<DndContext
						id="inventory-inbounds-table-dnd"
						sensors={sensors}
