...
export function DataTableHeader<TData>({
	...
	const firstStickyColumnId = tableConfig.stickyColumns[0]?.id;
	...
	}, [table, tableConfig.nonReorderableColumns]);
...
function renderHeaderContent<TData>(
	...
	if (columnId === "actions") {
		return <div className="flex w-full items-center justify-end" />;
	}

	if (columnId === firstStickyColumnId) {
		return (
