...
interface SalesResolutionTableState {
	columns: Column<SalesResolutionRow, unknown>[];
	setColumns: (columns: Column<SalesResolutionRow, unknown>[]) => void;
...
export const useSalesResolutionTableStore =
	create<SalesResolutionTableState>((set) => ({
		columns: [],
		rowSelection: {},
