...
import { type SiteActionRow, columns, getSiteActionRowId } from "./columns";
import { EmptyState, NoResults } from "./empty-states";
import { useSiteActionsTableStore } from "./store";
import { DataTableHeader } from "./table-header";

const NON_CLICKABLE_COLUMNS = new Set(["select"]);
const TABLE_ID = "site-actions";
const COLUMN_IDS = getColumnIds(columns);
const tableConfig = TABLE_CONFIGS[TABLE_ID];

type SiteActionsInput = RouterInputs["siteActions"]["index"];
type SiteActionsPage = {
	data?: SiteActionRow[];
	meta?: {
...
type Props = {
	...
	defaultFilters?: SiteActionsInput;
	singlePage?: boolean;
};
...
export function DataTable({
	...
	const { data, fetchNextPage, hasNextPage, isFetchingNextPage } =
		useSuspenseInfiniteQuery<SiteActionsPage>(infiniteQueryOptions as never);
