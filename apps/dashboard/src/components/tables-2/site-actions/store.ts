...
import type { SiteActionRow } from "./columns";

interface SiteActionsTableState {
	columns: Column<SiteActionRow, unknown>[];
	setColumns: (columns: Column<SiteActionRow, unknown>[]) => void;
...
export const useSiteActionsTableStore = create<SiteActionsTableState>(
	(set) => ({
		columns: [],
		rowSelection: {},
