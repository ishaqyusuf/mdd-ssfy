...
import type { BugReportRow } from "./columns";

interface BugReportsTableState {
	columns: Column<BugReportRow, unknown>[];
	setColumns: (columns: Column<BugReportRow, unknown>[]) => void;
...
export const useBugReportsTableStore = create<BugReportsTableState>((set) => ({
	columns: [],
