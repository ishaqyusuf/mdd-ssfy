				...
				<div className="flex flex-col gap-6 md:flex-row">
					...
					<div className="md:w-2/3">
						<Tabs defaultValue="purchase-history">
							...
							<TabsContent value="purchase-history" className="mt-4 space-y-4">
							...
							<TabsContent value="active-contracts" className="mt-4 space-y-4">
								<div className="space-y-4">
									{[1, 2].map((i) => (
										<div
											key={i}
							...
							<TabsContent value="notes" className="mt-4 space-y-4">
								<div className="space-y-4">
									<div className="rounded-lg border p-4">
										...
										<p className="text-sm">
											Client expressed interest in expanding their current
											software license to include additional modules. Follow up
											with a proposal by next week.
										</p>
									</div>
									<div className="rounded-lg border p-4">
										<div className="mb-2 flex items-center justify-between">
											<h4 className="font-medium">Contract Discussion</h4>
											<span className="text-xs text-muted-foreground">
												Oct 25, 2023
											</span>
										</div>
										<p className="text-sm">
											Discussed renewal terms for the annual support contract.
											Client requested pricing options for a 2-year commitment.
										</p>
									</div>
								</div>
