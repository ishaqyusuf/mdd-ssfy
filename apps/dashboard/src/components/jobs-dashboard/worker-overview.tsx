                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        <h2 className="max-w-2xl text-3xl font-semibold tracking-tight text-white md:text-4xl">
                                            Keep jobs moving and payments
                                            predictable.
                                        </h2>
                                        <p className="max-w-xl text-sm leading-6 text-slate-200">
                                            {session?.user?.name ||
                                                "Your dashboard"}{" "}
                                            gives you one clear place to submit
                                            jobs, stay document-ready, and keep
                                            an eye on what&apos;s waiting for
                                            review.
                                        </p>
                                    </div>
                                </div>
                    ...
                    <Card className="overflow-hidden rounded-[28px] border-0 bg-[linear-gradient(135deg,#fff7ed_0%,#ffffff_48%,#eff6ff_100%)] shadow-lg shadow-orange-100/70">
                        <CardContent className="space-y-4 p-6">
                            ...
                            <div className="space-y-3 text-sm text-slate-600">
                                <p>
                                    Clear job descriptions and a current
                                    insurance document reduce back-and-forth
                                    during review.
                                </p>
                                <Button
                                    asChild
