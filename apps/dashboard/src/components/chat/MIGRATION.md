...
- `rg -n "components/activity/inbox|components/activity/activity-history|from \"@/components/activity\"" apps/dashboard/src`
- `bun run --filter @gnd/dashboard typecheck` (or project-standard scoped gate)
