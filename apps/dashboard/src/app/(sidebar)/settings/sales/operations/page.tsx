...
export default async function Page() {
	await batchPrefetch([trpc.sales.getSalesHandoffTrigger.queryOptions()]);
	...
	return (
		<HydrateClient>
			...
			>
				<header>
					<h1 id="operations-settings-title" className="text-xl font-semibold">
						Operations
					</h1>
					<p className="mt-1 text-sm text-muted-foreground">
						Choose when payment makes an order ready for operational handoff.
					</p>
				</header>
