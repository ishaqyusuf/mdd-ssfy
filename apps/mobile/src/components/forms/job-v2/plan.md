...
- Use a single route entry at `apps/mobile/src/app/job-form`.
...
- Add shared navigation helpers in `apps/mobile/src/lib/job.ts` to branch old/new flows.
...
- [x] Create `apps/mobile/src/hooks/use-job-form-v2-params.ts`
...
- [x] Create `apps/mobile/src/hooks/use-job-form-v2.tsx`
...
- [x] Create `apps/mobile/src/components/forms/job-v2/job-v2-shell.tsx`
- [x] Create `apps/mobile/src/components/forms/job-v2/job-v2-header.tsx`
- [x] Create `apps/mobile/src/components/forms/job-v2/job-v2-footer.tsx`
- [x] Create `apps/mobile/src/components/forms/job-v2/ui/` primitives for V2-only look
- [x] Create step components under `apps/mobile/src/components/forms/job-v2/steps/`
- [x] Ensure visual style is intentionally different from old `components/forms/job/*`

### 4) V2 screen and integration
- [x] Create `apps/mobile/src/screens/job-form-v2-screen.tsx`
- [x] Integrate V2 provider + params + step renderer
- [x] Create or wire `apps/mobile/src/app/job-form` as the single entry route
- [x] Update `apps/mobile/src/screens/job-form-screen.tsx`
...
- [x] Expand `apps/mobile/src/lib/job.ts` with `editJob(job: Job)` and `openJob(job: Job)`
...
- [x] Create `apps/mobile/src/screens/job-overview-v2-screen.tsx`
- [x] Add V2 overview component folder `apps/mobile/src/components/job-overview-v2/`
- [x] Mirror key web overview sections from `apps/dashboard/src/components/modals/job-overview/index.tsx`:
