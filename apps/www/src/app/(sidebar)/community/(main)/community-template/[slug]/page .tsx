...
import ModelForm from "../../../../../(v1)/(loggedIn)/settings/community/_components/model-form/model-form";
import { getCommunityTemplate } from "../../../../../(v1)/(loggedIn)/settings/community/_components/home-template";
...
async function CommunityModelTemplatePage(props) {
