...
export default async function RegistrationSubmittedPage(props) {
	...
	const createdAgo = dayjs().diff(dayjs(e?.consumedAt), "minutes");
					...
					<div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
						<div className="space-y-3">
							...
							<p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
								Thank you for registering to become a dealer partner with GND
								Millwork. We have received your registration details and are
