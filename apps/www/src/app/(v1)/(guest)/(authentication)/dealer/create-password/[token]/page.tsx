			...
			<Shell className="sm:max-w-2xl">
				<Card>
					<CardHeader className="space-y-1">
						...
						<CardDescription>
							To complete your account setup, please create a secure password.
							Your password helps protect your account and ensures that only you
							can access your personal information and services.
						</CardDescription>
					</CardHeader>
