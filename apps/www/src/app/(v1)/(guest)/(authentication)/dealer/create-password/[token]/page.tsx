...
import { verifyToken } from "@/app-deps/(v1)/(guest)/(authentication)/dealer/create-password/[token]/action";
import Form from "@/app-deps/(v1)/(guest)/(authentication)/dealer/create-password/[token]/form";
