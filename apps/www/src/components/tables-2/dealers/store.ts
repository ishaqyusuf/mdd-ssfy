...
import type { DealerRow } from "./columns";

interface DealersTableState {
	columns: Column<DealerRow, unknown>[];
	setColumns: (columns: Column<DealerRow, unknown>[]) => void;
...
export const useDealersTableStore = create<DealersTableState>((set) => ({
	columns: [],
