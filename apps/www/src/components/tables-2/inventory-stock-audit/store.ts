...
import type { InventoryStockAuditRow } from "./columns";

interface InventoryStockAuditTableState {
	columns: Column<InventoryStockAuditRow, unknown>[];
	setColumns: (columns: Column<InventoryStockAuditRow, unknown>[]) => void;
...
export const useInventoryStockAuditTableStore =
	create<InventoryStockAuditTableState>((set) => ({
		columns: [],
