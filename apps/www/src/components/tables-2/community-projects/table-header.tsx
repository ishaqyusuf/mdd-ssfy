...
const TABLE_ID = "community-projects" satisfies TableId;
...
function SortButton({
	...
	const isDescending = currentSortValue === "desc";
	...
	return (
		<Button
			...
			variant="ghost"
			size="sm"
			className="h-7 max-w-full px-1 text-[11px] font-semibold uppercase text-slate-600 hover:bg-transparent dark:text-slate-300"
