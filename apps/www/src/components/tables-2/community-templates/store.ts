...
import type { CommunityTemplateRow } from "./columns";

interface CommunityTemplatesTableState {
	columns: Column<CommunityTemplateRow, unknown>[];
	setColumns: (columns: Column<CommunityTemplateRow, unknown>[]) => void;
...
export const useCommunityTemplatesTableStore =
	create<CommunityTemplatesTableState>((set) => ({
		columns: [],
