...
import {
	...
	columns,
	getContractorPayoutOverviewJobRowId,
} from "./columns";
import { EmptyState } from "./empty-states";
import { ContractorPayoutOverviewJobsSkeleton } from "./skeleton";
import { useContractorPayoutOverviewJobsTableStore } from "./store";
...
const TABLE_ID = "contractor-payout-overview-jobs";
const tableConfig = TABLE_CONFIGS[TABLE_ID];

type Props = {
	data: ContractorPayoutOverviewJobRow[];
	emptyText: string;
...
export function DataTable({
	...
	const tableData = useMemo<ContractorPayoutOverviewJobRow[]>(
		() => data,
		[data],
	);
	const table = useReactTable({
		data: tableData,
		getRowId: getContractorPayoutOverviewJobRowId,
		columns,
