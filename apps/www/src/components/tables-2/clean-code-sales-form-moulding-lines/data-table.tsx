...
const TABLE_ID = "clean-code-sales-form-moulding-lines";
...
export function DataTable({ data, itemType, initialSettings }: Props) {
	...
	const tableData = useMemo<CleanCodeSalesFormMouldingLineRow[]>(
		() => data,
		[data],
	);
