...
import type { InventoryProduct } from "./columns";

interface InventoryProductsTableState {
	columns: Column<InventoryProduct, unknown>[];
	setColumns: (columns: Column<InventoryProduct, unknown>[]) => void;
...
export const useInventoryProductsTableStore =
	create<InventoryProductsTableState>((set) => ({
		columns: [],
		rowSelection: {},
