...
const TABLE_ID = "clean-code-door-size-select-lines";
...
export function DataTable({
	...
	const tableData = useMemo<CleanCodeDoorSizeSelectLineRow[]>(
		() => data,
		[data],
	);
	const effectiveColumnVisibility = useMemo(
		...
		[columnVisibility, noHandle, showSwing],
	);
	...
	return (
		<div className="relative">
			<div className="w-full">
				...
				>
					<DndContext
						id="clean-code-door-size-select-lines-table-dnd"
						sensors={sensors}
