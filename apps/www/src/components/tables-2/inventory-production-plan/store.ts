...
import type { InventoryProductionPlanRow } from "./columns";

interface InventoryProductionPlanTableState {
	columns: Column<InventoryProductionPlanRow, unknown>[];
	setColumns: (columns: Column<InventoryProductionPlanRow, unknown>[]) => void;
...
export const useInventoryProductionPlanTableStore =
	create<InventoryProductionPlanTableState>((set) => ({
		columns: [],
