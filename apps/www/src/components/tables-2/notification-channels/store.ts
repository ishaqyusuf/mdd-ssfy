...
import type { NotificationChannelRow } from "./columns";

interface NotificationChannelsTableState {
	columns: Column<NotificationChannelRow, unknown>[];
	setColumns: (columns: Column<NotificationChannelRow, unknown>[]) => void;
...
export const useNotificationChannelsTableStore =
	create<NotificationChannelsTableState>((set) => ({
		columns: [],
