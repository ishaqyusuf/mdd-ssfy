...
import type { InventoryKindReviewRow } from "./columns";

interface InventoryKindReviewTableState {
	columns: Column<InventoryKindReviewRow, unknown>[];
	setColumns: (columns: Column<InventoryKindReviewRow, unknown>[]) => void;
...
export const useInventoryKindReviewTableStore =
	create<InventoryKindReviewTableState>((set) => ({
		columns: [],
