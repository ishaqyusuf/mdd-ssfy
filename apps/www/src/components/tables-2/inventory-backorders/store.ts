...
interface InventoryBackordersTableState {
	columns: Column<InventoryBackorderRow, unknown>[];
	setColumns: (columns: Column<InventoryBackorderRow, unknown>[]) => void;
...
export const useInventoryBackordersTableStore =
	create<InventoryBackordersTableState>((set) => ({
		columns: [],
