...
import {
	...
	columns,
	getEmployeeProfileRowId,
} from "./columns";
import { EmptyState } from "./empty-states";
import { EmployeeProfilesSkeleton } from "./skeleton";
import { useEmployeeProfilesTableStore } from "./store";
import { DataTableHeader } from "./table-header";

const NON_CLICKABLE_COLUMNS = new Set(["actions"]);
const TABLE_ID = "employee-profiles";
...
export function DataTable({
	...
	const tableData = useMemo<EmployeeProfileRow[]>(() => data, [data]);
	const table = useReactTable({
		data: tableData,
		getRowId: getEmployeeProfileRowId,
		columns,
	...
	return (
		<div className="relative">
			<div className="w-full">
				...
				>
					<DndContext
						id="employee-profiles-table-dnd"
						sensors={sensors}
