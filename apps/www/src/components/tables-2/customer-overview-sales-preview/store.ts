...
import type { CustomerOverviewSalesPreviewRow } from "./columns";

interface CustomerOverviewSalesPreviewTableState {
	columns: Column<CustomerOverviewSalesPreviewRow, unknown>[];
	setColumns: (
		columns: Column<CustomerOverviewSalesPreviewRow, unknown>[],
	) => void;
...
export const useCustomerOverviewSalesPreviewTableStore =
	create<CustomerOverviewSalesPreviewTableState>((set) => ({
		columns: [],
