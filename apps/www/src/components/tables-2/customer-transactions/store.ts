...
import type { CustomerTransactionRow } from "./columns";

interface CustomerTransactionsTableState {
	columns: Column<CustomerTransactionRow, unknown>[];
	setColumns: (columns: Column<CustomerTransactionRow, unknown>[]) => void;
...
export const useCustomerTransactionsTableStore =
	create<CustomerTransactionsTableState>((set) => ({
		columns: [],
