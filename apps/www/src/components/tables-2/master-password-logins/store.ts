...
import type { MasterPasswordLoginRow } from "./columns";

interface MasterPasswordLoginsTableState {
	columns: Column<MasterPasswordLoginRow, unknown>[];
	setColumns: (columns: Column<MasterPasswordLoginRow, unknown>[]) => void;
...
export const useMasterPasswordLoginsTableStore =
	create<MasterPasswordLoginsTableState>((set) => ({
		columns: [],
