...
import {
	type CommunityModelCostTaskRow,
	columns,
	getCommunityModelCostTaskRowId,
} from "./columns";
...
export function DataTable({ data, control, initialSettings }: Props) {
	...
	const tableData = useMemo<CommunityModelCostTaskRow[]>(() => data, [data]);
	const table = useReactTable({
		data: tableData,
		getRowId: getCommunityModelCostTaskRowId,
		columns,
	...
	return (
		<div className="relative">
			<div className="w-full">
				...
				>
					<DndContext
						id="community-model-cost-form-tasks-table-dnd"
						sensors={sensors}
