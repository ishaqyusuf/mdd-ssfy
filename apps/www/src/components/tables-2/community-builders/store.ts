...
import type { CommunityBuilderRow } from "./columns";

interface CommunityBuildersTableState {
	columns: Column<CommunityBuilderRow, unknown>[];
	setColumns: (columns: Column<CommunityBuilderRow, unknown>[]) => void;
...
export const useCommunityBuildersTableStore =
	create<CommunityBuildersTableState>((set) => ({
		columns: [],
