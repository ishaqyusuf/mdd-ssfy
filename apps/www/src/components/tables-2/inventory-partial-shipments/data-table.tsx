...
import { InventoryPartialShipmentsSkeleton } from "./skeleton";
import { useInventoryPartialShipmentsTableStore } from "./store";
import { DataTableHeader } from "./table-header";

const NON_CLICKABLE_COLUMNS = new Set(["hold", "actions"]);
...
export function DataTable({
	...
	const tableData = useMemo<InventoryPartialShipmentRow[]>(() => data, [data]);
	...
	if (isLoading) {
		return (
			<InventoryPartialShipmentsSkeleton initialSettings={initialSettings} />
		);
	}
