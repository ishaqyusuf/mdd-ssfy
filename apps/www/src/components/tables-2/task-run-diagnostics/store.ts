...
import type { TaskRunDiagnosticsRow } from "./columns";

interface TaskRunDiagnosticsTableState {
	columns: Column<TaskRunDiagnosticsRow, unknown>[];
	setColumns: (columns: Column<TaskRunDiagnosticsRow, unknown>[]) => void;
...
export const useTaskRunDiagnosticsTableStore =
	create<TaskRunDiagnosticsTableState>((set) => ({
		columns: [],
