...
import type { CommunityInstallCostTableRow } from "./columns";

interface CommunityInstallCostsTableState {
	columns: Column<CommunityInstallCostTableRow, unknown>[];
	setColumns: (
		columns: Column<CommunityInstallCostTableRow, unknown>[],
	) => void;
...
export const useCommunityInstallCostsTableStore =
	create<CommunityInstallCostsTableState>((set) => ({
		columns: [],
