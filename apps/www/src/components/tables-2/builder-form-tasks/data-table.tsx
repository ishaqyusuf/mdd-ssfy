...
import {
	type BuilderFormTaskRow,
	columns,
	getBuilderFormTaskRowId,
} from "./columns";
import { DataTableHeader } from "./table-header";

const NON_CLICKABLE_COLUMNS = new Set(["actions"]);
const TABLE_ID = "builder-form-tasks";
const COLUMN_IDS = getColumnIds(columns);
const tableConfig = TABLE_CONFIGS[TABLE_ID];

type Props = {
	data: BuilderFormTaskRow[];
...
export function DataTable({
	...
	const tableData = useMemo<BuilderFormTaskRow[]>(() => data, [data]);
	const table = useReactTable({
		data: tableData,
		getRowId: getBuilderFormTaskRowId,
		columns,
	...
	return (
		<div className="relative">
			<div className="w-full">
				...
				>
					<DndContext
						id="builder-form-tasks-table-dnd"
						sensors={sensors}
