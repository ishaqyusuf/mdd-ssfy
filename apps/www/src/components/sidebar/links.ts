...
export const linkModules = [
	_module("HRM", "hrm", "GND HRM", [
		...
		_section("", null, [
			...
			_link("Payment Receipts", "payment", "/contractor/jobs/payments").access(
	...
	_module("Community", "communityInvoice", "GND Community", [
		_section("main", null, [
			_link(
				...
				[
					...
					_subLink("Productions", "/community/unit-productions").access(
						// canEditProject,
		...
		_section("settings", "Settings", [
			_link("Community Setting", "settings", null, [
				_subLink("Install Costs", "/settings/community/install-costs").access(
					canEditProject,
				).data,
				_subLink("Model Costs", "/settings/community/model-costs").access(
					canEditProject,
				).data,
				_subLink(
					"Community Cost",
	...
	_module("Sales", "orders", "GND Sales", [
		...
		_section("", "", [
			_link("Productions", "production", "/sales-book/productions").access(
				_perm.is("editOrders"),
			).data,
