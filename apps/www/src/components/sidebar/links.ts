...
export const linkModules = [
	...
	_module("Community", "project", "GND Community", [
		_section("", null, [
			...
			// .data,
			_link("Projects", "project", "/community/projects").access(canEditProject)
				.data,
			_link("Units", "home", "/community/project-units").access(canEditProject)
				.data,
				...
				_module("Inventory", "products", "GND Inventory", [
					_section("", null, [
						...
						_link("Inbounds", "inbound", "/inventory/inbounds")
							.access(_role.is("Super Admin")).data,
						_link("Allocations", "report", "/inventory/allocations")
							.access(_role.is("Super Admin")).data,
						_link("Stock Movements", "report", "/inventory/stocks")
							.access(_role.is("Super Admin")).data,
						_link("Suppliers", "products", "/inventory/suppliers")
							.access(_role.is("Super Admin")).data,
