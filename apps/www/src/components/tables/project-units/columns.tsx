		...
		<>
			...
			>
				<Badge
					...
					style={{
						backgroundColor:
							item.jobCount > 0 ? colorsObject.limeGreen : colorsObject.dimGray,
					}}
					className={cn("h-5 px-1 whitespace-nowrap  text-xs text-slate-100")}
				>
			...
			<div className="flex items-start gap-3">
				...
				>
					<div className="flex flex-wrap items-center gap-2">
						...
						<Badge
							variant={
								item?.template?.version === "v1" ? "secondary" : "success"
							}
