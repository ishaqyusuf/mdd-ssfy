...
export function ProductionWorkspace({
    ...
    const pageCopy = workerMode
        ...
        : {
              ...
              helper: "Built for fast daily scanning, filtering, and order follow-up.",
          };
                    ...
                    <CardHeader className="pb-3">
                        <div className="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <CardDescription>
                                    Compact date view for the next few working
                                    days.
                                </CardDescription>
                            </div>
                            <Button
                    ...
                    <CardContent className="space-y-4">
                        <div className="overflow-hidden rounded-2xl border bg-muted/20">
                            <Calendar
                                ...
                                modifiersClassNames={{
                                    hasDue: "rounded-full border border-sky-200 bg-sky-50 font-semibold text-sky-900",
                                }}
                                className="w-full"
                            />
                        </div>
            ...
            {!workerMode && dashboard?.alerts.pastDue?.length ? (
                <Card className="rounded-3xl border-red-200/80 bg-red-50/60">
                    <CardHeader className="pb-3">
                        ...
                        <CardDescription>
                            Orders that already slipped and should be recovered
                            first.
                        </CardDescription>
                    </CardHeader>
...
function humanizeActiveFilter(activePreset: string) {
    ...
    if (/^\d{4}-\d{2}-\d{2}$/.test(activePreset))
        return `Due on ${activePreset}`;
    return activePreset;
}
