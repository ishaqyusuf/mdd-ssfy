    ...
    "p-2 px-4 flex flex-col h-screens w-full overflow-x-hidden ",
    {
        variants: {
            ...
            size: {
                ...
                "2xl": "data-[side=left]:w-full data-[side=right]:w-full data-[side=left]:sm:max-w-5xl data-[side=right]:sm:max-w-5xl data-[side=left]:md:max-w-2xl data-[side=right]:md:max-w-2xl",
                "3xl": "data-[side=left]:w-full data-[side=right]:w-full data-[side=left]:sm:max-w-5xl data-[side=right]:sm:max-w-5xl data-[side=left]:md:max-w-3xl data-[side=right]:md:max-w-3xl",
                "4xl": "data-[side=left]:w-full data-[side=right]:w-full data-[side=left]:sm:max-w-5xl data-[side=right]:sm:max-w-5xl data-[side=left]:md:max-w-4xl data-[side=right]:md:max-w-4xl",
                "5xl": "data-[side=left]:w-full data-[side=right]:w-full data-[side=left]:sm:max-w-5xl data-[side=right]:sm:max-w-5xl data-[side=left]:md:max-w-6xl data-[side=right]:md:max-w-6xl",
                default: "",
