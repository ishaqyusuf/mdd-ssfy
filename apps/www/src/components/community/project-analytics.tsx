...
import { useQuery, useSuspenseQuery } from "@gnd/ui/tanstack";
...
type ProjectsOverview = RouterOutputs["community"]["communityProjectsOverview"];
...
function useProjectsOverviewData() {
    ...
    return useSuspenseQuery(
        trpc.community.communityProjectsOverview.queryOptions({
            ...
            status:
                (filters.status as "active" | "archived" | null) ?? undefined,
        }),
    );
}
