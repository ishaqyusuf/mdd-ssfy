                ...
                <CardContent className="flex flex-col gap-4 p-6 lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div className="grid gap-2 sm:grid-cols-2">
                            <div className="rounded-xl bg-slate-50 px-3 py-2">
                                ...
                                <p className="mt-1 text-sm font-medium text-slate-900">
                                    {data.project.meta?.supervisor?.name ||
                                        "Unassigned"}
                                </p>
                                <p className="text-xs text-slate-500">
                                    {data.project.meta?.supervisor?.email ||
                                        "No email set"}
                                </p>
                            </div>
                            <div className="rounded-xl bg-slate-50 px-3 py-2">
                    ...
                    <div className="flex flex-wrap gap-2 lg:justify-end">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                modal.openModal(
                                    <ProjectModal data={data.project as any} />,
                                )
                            }
                        >
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                        {data.productionStatus.map((item) => (
                            ...
                            >
                                ...
                                <p className="text-xs text-slate-500">
                                    {item.percent}% of production items
                                </p>
                            </div>
                        ))}
                    </div>
                ...
                >
                    <div className="space-y-3">
                        ...
                        <div className="rounded-xl bg-slate-50 px-4 py-3">
                            ...
                            <p className="mt-1 text-2xl font-semibold text-slate-950">
                                {formatCurrency.format(
                                    data.summary.invoicePaidAmount,
                                )}
                            </p>
                        </div>
                        <div className="rounded-xl bg-slate-50 px-4 py-3">
    ...
    const templatePath =
        data.unit.communityTemplate?.version === "v2"
            ...
            : data.unit.communityTemplate?.slug
              ? `/community/community-template/${data.unit.communityTemplate.slug}/v1`
              : null;
                ...
                <CardContent className="flex flex-col gap-4 p-6 lg:flex-row lg:items-start lg:justify-between">
                    <div className="space-y-3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {data.unit.modelName || "No model"} •{" "}
                                {data.unit.project?.title || "No project"}
                            </p>
                        </div>
                        <div className="grid gap-2 sm:grid-cols-2">
                            <div className="rounded-xl bg-slate-50 px-3 py-2">
                                ...
                                <p className="mt-1 text-sm font-medium text-slate-900">
                                    {data.unit.project?.title ||
                                        "Unknown project"}
                                </p>
                                <p className="text-xs text-slate-500">
                                    {data.unit.project?.builder?.name ||
                                        "Unknown builder"}
                                </p>
                            </div>
                            <div className="rounded-xl bg-slate-50 px-3 py-2">
                                ...
                                <p className="mt-1 text-sm font-medium text-slate-900">
                                    {data.unit.communityTemplate?.modelName ||
                                        "No template"}
                                </p>
                                <p className="text-xs text-slate-500">
                                    {data.unit.communityTemplate?.version ||
                                        "No version"}
                                </p>
                            </div>
                        </div>
                ...
                >
                    <div className="grid gap-3 md:grid-cols-2">
                        ...
                        <div className="rounded-xl border border-slate-200 px-3 py-3">
                            ...
                            <p className="text-xs text-slate-500">
                                Operational work logged on this unit
                            </p>
                        </div>
                        <div className="rounded-xl border border-slate-200 px-3 py-3">
                            <p className="text-xs uppercase tracking-[0.16em] text-slate-400">
                            ...
                            <p className="text-xs text-slate-500">
                                Unit entered the community workflow
                            </p>
                        </div>
                    </div>
                </SectionCard>
