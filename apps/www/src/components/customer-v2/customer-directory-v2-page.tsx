        ...
        <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div className="space-y-2">
                    ...
                    <p className="max-w-2xl text-sm text-muted-foreground">
                        Manage customer accounts, review wallet and payment
                        posture, and jump directly into the new customer
                        overview workspace.
                    </p>
                </div>
                ...
                <DirectoryStatCard
                    ...
                    value={
                        <StatValue
                            ...
                            value={
                                summaryQuery.data?.totalCustomers ?? total ?? 0
                            }
                        />
                    }
                />
                <DirectoryStatCard
                    ...
                    value={
                        <StatValue
                            isPending={summaryQuery.isPending}
                            value={
                                summaryQuery.data?.businessCustomers ??
                                visibleBusiness
                            }
                        />
                    }
                ...
                <DirectoryStatCard
                    ...
                    value={
                        <StatValue
                            isPending={summaryQuery.isPending}
                            value={
                                summaryQuery.data?.customersWithEmail ??
                                visibleWithEmail
                            }
                        />
                    }
            ...
            <Card>
                <CardHeader className="pb-3">
                    ...
                    <CardDescription>
                        Search by customer name, phone, email, or account
                        details.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card className="overflow-hidden">
                <CardHeader className="border-b bg-muted/20 pb-3">
                    ...
                    <CardDescription>
                        Select a row to open the v2 side sheet or jump to the
                        full-page customer workspace.
                    </CardDescription>
                </CardHeader>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        >
                                                            <Link
                                                                href={`/sales-book/customers/v2/${encodeURIComponent(accountNo)}`}
                                                            >
                                                                Open page
                                                            </Link>
                                                        </Button>
