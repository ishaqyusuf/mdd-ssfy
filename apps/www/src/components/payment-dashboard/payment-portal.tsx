...
export function PaymentPortal() {
    ...
    const readyToPayJobs =
        portal?.jobs.filter((job) => job.paymentStage === "ready-to-pay")
            .length || 0;
                ...
                <CardContent className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Create a PDF summary of all unpaid jobs across
                            contractors, starting with the overall totals before
                            the contractor-by-contractor breakdown.
                        </p>
                    </div>
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <div className="rounded-xl border bg-background px-4 py-2 text-sm">
                            ...
                            <p className="mt-1 font-semibold text-foreground">
                                {formatCurrency(
                                    dashboardQuery.data?.summary.totalPay,
                                )}
                            </p>
                        </div>
                        <Button
                            ...
                            disabled={
                                dashboardQuery.isPending || !contractors.length
                            }
                        >
                ...
                <Card className="hidden overflow-hidden xl:sticky xl:top-6 xl:flex xl:h-[calc(100vh-7rem)] xl:flex-col">
                    <CardHeader className="gap-4 border-b bg-muted/30">
                        <div>
                            ...
                            <CardDescription>
                                Choose a contractor to inspect pending review
                                and ready-to-pay jobs in one place.
                            </CardDescription>
                        </div>
                    ...
                    <CardContent className="p-0 xl:flex-1 xl:min-h-0">
                        {dashboardQuery.isPending ? (
                            ...
                            <div className="flex min-h-[320px] flex-col items-center justify-center gap-2 p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Once approved jobs are unpaid, they will
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                                                    ...
                                                    >
                                                        {contractor.insurance.state.replace(
                                                            "_",
                                                            " ",
                                                        )}
                                                    </Badge>
                        ...
                        {portal ? (
                            <div className="flex flex-col gap-4">
                                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                                    <div>
                                        <CardTitle>
                                            {portal.contractor.name}
                                        </CardTitle>
                                        <CardDescription>
                                            {portal.contractor.email ||
                                                "No email on file"}
                                        </CardDescription>
                                    </div>
                                ...
                                <div className="grid gap-3 md:grid-cols-3">
                                    ...
                                    <MiniInfoCard
                                        label="Ready to pay"
                                        value={String(
                                            portal.contractor.readyToPayCount,
                                        )}
                                    />
                                    <MiniInfoCard
                                        label="Total pay"
                                        value={formatCurrency(
                                            portal.contractor.totalPay,
                                        )}
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <CardDescription>
                                    Select a contractor to load payable jobs and
                                    payout controls.
                                </CardDescription>
                            </div>
                        )}
                                ...
                                selectedPendingReviewJobs.length > 0 ? (
                                    <div className="flex flex-col gap-3 rounded-2xl border bg-muted/20 p-4 sm:flex-row sm:items-center sm:justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Approve or reject the marked
                                                submissions directly from this
                                                view.
                                            </p>
                                        </div>
                                        <div className="flex items-center gap-2">
...
function JobListItem({
    ...
    const canMarkSubmitted =
        job.status !== "Submitted" && job.status !== "Paid";
        ...
        >
            <div className="flex items-start gap-3">
                <Checkbox
                    checked={checked}
                    disabled={
                        isPendingReviewMode ? !canReviewThisJob : !canPayThisJob
                    }
                        ...
                        {isPendingReviewMode && canReviewThisJob ? (
                            <div className="flex items-center gap-2">
                                <Button
                                    ...
                                    disabled={
                                        isReviewPending || !canMarkSubmitted
                                    }
                                >
                                    Mark submitted
                                </Button>
    ...
    return (
        <div className="flex min-h-[320px] flex-col items-center justify-center gap-2 rounded-2xl border border-dashed bg-muted/20 p-6 text-center">
            ...
            <p className="max-w-md text-sm text-muted-foreground">
                Click any job row once the list loads to open its overview
                before you finalize the payout.
            </p>
        </div>
    );
}
                        ...
                        <div className="rounded-2xl border bg-muted/20 p-4">
                            <div className="flex items-baseline justify-between gap-3">
                                ...
                                <div className="text-right text-xs text-muted-foreground">
                                    ...
                                    <p>
                                        {chargePercentage.toFixed(0)}% discount
                                    </p>
                                </div>
                            </div>
