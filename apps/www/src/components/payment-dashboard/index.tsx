                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-2 text-sm text-muted-foreground md:text-base">
                                Monitor unpaid contractor work, spot insurance
                                blockers, and jump into the pay portal when
                                finance is ready to batch jobs.
                            </p>
                        </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.6fr)_minmax(320px,1fr)]">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            All contractors with pending review or ready-to-pay
                            work.
                        </CardDescription>
                    </CardHeader>
                ...
                <div className="grid gap-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                The clean path for every contractor payout
                                batch.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-3">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                The latest contractor payout batches recorded in
                                the system.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-3">
                ...
                <div className="relative mt-3">
                    <p
                        className={cn(
                            ...
                            maskUntilHover &&
                                "select-none blur-sm group-hover:blur-0",
                        )}
                    >
                        {value}
                    </p>
