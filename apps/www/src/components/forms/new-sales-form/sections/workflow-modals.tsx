...
export function updateDoorRowBasePrice(
	...
	const priorBase = firstFiniteNumber((row.meta as any)?.baseUnitPrice);
...
export function DoorPriceCell({
	...
	const baseUnit = firstFiniteNumber((row.meta as any)?.baseUnitPrice);
								...
								>
									...
									<div className="space-y-3">
										{group.rules.map((rule, ruleIndex) => {
											...
											const stepOptions =
												availableStepMap.get(String(rule.stepUid || ""))
													?.components || [];
