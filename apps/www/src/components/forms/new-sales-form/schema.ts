...
export type NewSalesFormShelfProductsInput = Exclude<
	...
	void
>;
export type NewSalesFormShelfProductIndexInput = Exclude<
	RouterInputs["newSalesForm"]["getShelfProductIndex"],
	void
>;
export type NewSalesFormShelfProductDetailsInput = Exclude<
	RouterInputs["newSalesForm"]["getShelfProductDetails"],
	void
>;
export type NewSalesFormShelfProductSearchInput = Exclude<
	RouterInputs["newSalesForm"]["searchShelfProducts"],
	void
>;
