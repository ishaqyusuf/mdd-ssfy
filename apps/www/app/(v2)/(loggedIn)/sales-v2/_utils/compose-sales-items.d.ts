...
export declare function composeSalesItems(data: ViewSaleType): {
    ...
    doors: {
        ...
        housePackageTools: NonNullable<ViewSaleType["items"][0]["housePackageTool"]>[];
    }[];
};
export declare function composeDoorDetails(steps: ViewSaleType["items"][0]["formSteps"], item: ViewSaleType["items"][0]): any;
