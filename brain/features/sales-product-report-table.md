...
- Default ordering: `sales.getProductReport` sorts computed report rows by `units` descending before applying cursor pagination, with product name and id as stable tie-breakers.
