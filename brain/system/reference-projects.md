...
## Purpose
Lists local reference projects that define architecture, implementation, and integration patterns for GND.
...
- `school-clerk`: Local reference for tenant-aware auth patterns, dashboard routing, and pragmatic product flows.
- `halaal-coperative`: Secondary local implementation reference when a pattern is closer to cooperative or business workflow needs.
