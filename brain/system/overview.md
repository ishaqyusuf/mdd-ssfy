...
- Local app/dev surfaces use explicit project-owned ports in the `3000-3009` range: `www` on `3000`, shared `portless` proxy on `3001`, Expo Metro on `3002`, email preview on `3003`, API on `3004`, the production-env www smoke profile on `3005`, dealership on `3006`, `apps/web` on `3007`, site on `3008`, and backlog on `3009`; Docker infrastructure ports remain separate.
