...
- [ ] Sales Orders V2: build the clean `sales-book` orders workspace on dedicated v2 query/filter contracts, summary widgets, and a reusable table shell (`brain/features/sales-orders-v2.md`)
