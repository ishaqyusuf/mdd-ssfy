...
const commands = [
	...
	},
	{
		...
		args: [
			...
			"apps/dashboard/src/components/forms/new-sales-form/sections/use-workflow-component-admin.test.ts",
		],
	},
	{
		label: "sales quote overview open params tests",
		args: ["test", "apps/dashboard/src/hooks/sales-overview-open-params.test.ts"],
	},
	{
	...
	},
	{
		...
		args: ["run", "--filter", "@gnd/dashboard", "typecheck"],
		...
		watchPaths: [
			...
			"apps/dashboard/src/hooks/sales-overview-open-params.ts",
			"apps/dashboard/src/hooks/use-sales-overview-open.ts",
			"apps/dashboard/src/hooks/use-sales-overview-query.ts",
